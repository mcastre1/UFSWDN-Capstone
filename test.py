...
class CapstoneTestCase(unittest.TestCase):
    ...
    def test_create_job(self):
        data = {"job_name":"job", "contact_name":"contact name", "contact_phone":"1111",
                  "address":"address", "material":"material", "status":"status", "edge_finish":"edge_finish", "sinks":"[1,2]"}
        
        res = self.client().post('/job', data=data, headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_view_job(self):
        job = Job(job_name="job", contact_name="contact name", contact_phone="1111",
                  address="address", material="material", status="status", edge_finish="edge_finish", sinks=[1,2])
        job.insert()
        
        res = self.client().get(f'/job/{job.id}', headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_view_job_400_error(self):
        res = self.client().get('/job/1000000000', headers={'Authorization':self.jwt})
    ...
    def test_update_job(self):
        ...
        data = {"job_name":"jobx", "contact_name":"contactname", "contact_phone":"00001111",
                  "address":"addressxx", "material":"materialx", "status":"status", "edge_finish":"edge_finish", "sinks":[1,2]}
        

        res = self.client().get(f'/job/{job.id}', data=data, headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_update_job_400_error(self):
        res = self.client().get('/job/10101010', headers={'Authorization':self.jwt})

        self.assertEqual(res.status_code, 400)

    def test_inventory(self):
        res = self.client().get('/inventory', headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_view_inventory_item(self):
        ...
        res = self.client().get(f'/inventory/{inventory_item.id}', headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_view_inventory_item_error(self):
        res = self.client().get('/inventory/444444', headers={'Authorization':self.jwt})
    ...
    def test_update_inventory_item(self):
        ...
        res = self.client().get(f'/inventory/{inventory_item.id}', headers={'Authorization':self.jwt}, data=data)
        data = json.loads(res.data)
    ...
    def test_update_inventory_item(self):
        ...
        res = self.client().get('/inventory/90', headers={'Authorization':self.jwt}, data=data)
        data = json.loads(res.data)

        self.assertEqual(res.status_code, 400)
    
    def test_add_inventory_item_form(self):
        res = self.client().get('/inventory/add', headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_add_inventory_item(self):
        ...
        res = self.client().post('/inventory/add', headers={'Authorization':self.jwt}, data=data)
        data = json.loads(res.data)
    ...
    def test_delete_inventory_item(self):
        ...
        res = self.client().delete(f'/inventory/{inventory_item.id}/delete_inventory_item', headers={'Authorization':self.jwt})
        data = json.loads(res.data)

        self.assertEqual(res.status_code, 400)

    def test_delete_inventory_item_error(self):
        res = self.client().delete(f'/inventory/3000/delete_inventory_item', headers={'Authorization':self.jwt})
    ...
    def test_view_sink(self):
        ...
        res = self.client().get(f'/sinks/{sink.id}', headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_view_sink_error(self):
        res = self.client().get('/sinks/1234551', headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_update_sink(self):
        ...
        res = self.client().get(f'/sinks/{sink.id}', headers={'Authorization':self.jwt}, data=data)
        data = json.loads(res.data)
    ...
    def test_update_sink_error(self):
        ...
        res = self.client().get('/sinks/100000', headers={'Authorization':self.jwt}, data=data)
        data = json.loads(res.data)
    ...
    def test_delete_sink(self):
        ...
        res = self.client().delete(f'/sinks/{sink.id}/delete_sink', headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_delete_sink_error(self):
        ...
        res = self.client().delete(f'/sinks/2400000/delete_sink', headers={'Authorization':self.jwt})
        data = json.loads(res.data)

        self.assertEqual(res.status_code, 400)

    def test_add_sink_form(self):
        res = self.client().get('/sinks/add', headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_add_sink(self):
        ...
        res = self.client().post('/sinks/add', data=data, headers={'Authorization':self.jwt})
        data = json.loads(res.data)
    ...
    def test_get_sinks_with_user_role(self):
        ...
        res = self.client().get('/sinks', headers={'Authorization':self.user_auth})
        data = json.loads(res.data)
